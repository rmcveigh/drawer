...
(function() {
  ...
  Snap.plugin( function( Snap, Element, Paper, global ) {
    ...
    // Element.prototype.ftCreateVrtHandles = function() {
    //   this.ftInit();
    //   var freetransEl = this;
    //   var bb = freetransEl.getBBox();
    //   var rotateDragger = this.paper.circle(bb.cx + ftOption.handleLength, bb.cy + bb.height/2, ftOption.handleRadius ).attr({ fill: ftOption.handleFill });
    ...
    //   var handlesGroup = this.paper.g( this, joinLine, rotateDragger, translateDragger );
    //   handlesGroup.drag();
    // }
    ...
    Element.prototype.ftCreateHandles = function() {
      ...
      // var joinLine = freetransEl.ftDrawJoinLine( rotateDragger );
      var handlesGroup = this.paper.g( translateDragger );
    ...
    Element.prototype.ftCreateHrzHandles = function() {
      this.ftInit();
      var freetransEl = this;
      var bb = freetransEl.getBBox();
